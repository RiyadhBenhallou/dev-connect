        ...
        <div className="mx-auto max-w-2xl py-12">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 dark:text-gray-200 text-gray-600">
              ...
              sessions. Solve complex problems together, learn new skills, and
              build lasting connections.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                href="/api/auth/signin"
                className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold dark:text-white text-gray-200 shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Get started
              </Link>
            </div>
